...
| PATCH  | `/users/me/addresses/:id`         | customer | Cập nhật địa chỉ                 |
| DELETE | `/users/me/addresses/:id`         | customer | Xoá địa chỉ                      |
| PATCH  | `/users/me/addresses/:id/default` | customer | Đặt làm địa chỉ mặc định         |
...
| PATCH  | `/users/:id/active` | admin | Khoá / Mở khoá tài khoản                  |
...
_Tài liệu này được tạo tự động dựa trên thiết kế database và mô tả dự án. Cập nhật theo tiến độ phát triển._
